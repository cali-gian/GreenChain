...
export async function fetchElectricityConsumption(date, value) {
...
export async function fetchEmissions(date, value) {
...
export async function fetchEmissionsMATIC(date) {
...
export async function fetchEmissionsSOL(date) {
